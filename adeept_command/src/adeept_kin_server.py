...
def handle_inverse_kinematics(req):
    ...
    if phi == 0 and theta == 0 and psi == 0:
      ...
      try:
          ...
          q2a = atan2(z-100,sqrt(x**2+y**2))
          q2_1b = atan2(link4hypotenuse*sin(temp3_1), (link3d + link4hypotenuse*cos(temp3_1)))
          q2_2b = atan2(link4hypotenuse*sin(temp3_2), (link3d + link4hypotenuse*cos(temp3_2)))
          temp2_1 = q2a-q2_1b
          temp2_2 = q2a-q2_2b
